...
\begin{itemize}
  \item Técnico dos times da Faculdade de Jaguariúna que participarão da \textbf{Maratona de Programação} (ICPC) 2014;  
  ...
  \item Autor do blog \textbf{Marllon's blog} (\url{http://marllonalves.com});
  {\fb}\setmainfont[SmallCapsFont=Fontin SmallCaps]{Fontin-Regular}\\
\end{itemize}
